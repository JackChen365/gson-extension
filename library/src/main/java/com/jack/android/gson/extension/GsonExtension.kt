...
internal const val JSON_DEFAULT_DOUBLE = 0.0
internal const val JSON_DEFAULT_FLOAT = 0f
internal const val JSON_DEFAULT_INT = 0
internal const val JSON_DEFAULT_LONG = 0L
internal const val JSON_DEFAULT_STRING = ""
internal const val JSON_DEFAULT_BOOLEAN = false
...
fun <T> toJson(item: T): String {
    ...
    result.outputDebugLogIfNecessary()
    return result.getOrNull() ?: JSON_DEFAULT_STRING
}
