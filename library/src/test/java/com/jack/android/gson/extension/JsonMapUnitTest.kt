...
class JsonMapUnitTest {
    ...
    fun testNullableLongMapDeserialize() {
        ...
        Assert.assertNotNull(map)
        Assert.assertEquals(2, map!!.size)
        Assert.assertEquals(mapOf("key1" to 0L, "key2" to 0L), map)
    }
    ...
    fun testNullableFloatMapDeserialize() {
        ...
        Assert.assertNotNull(map)
        Assert.assertEquals(2, map!!.size)
        Assert.assertEquals(mapOf("key1" to 0f, "key2" to 0f), map)
    }
    ...
    fun testNullableDoubleMapDeserialize() {
        ...
        Assert.assertNotNull(map)
        Assert.assertEquals(2, map!!.size)
        Assert.assertEquals(mapOf("key1" to 0.0, "key2" to 0.0), map)
    }
    ...
    fun testNullableBooleanMapDeserialize() {
        ...
        Assert.assertNotNull(map)
        Assert.assertEquals(2, map!!.size)
        Assert.assertEquals(mapOf("key1" to false, "key2" to false), map)
    }
    ...
    fun testNullableStringMapDeserialize() {
        ...
        Assert.assertNotNull(map)
        Assert.assertEquals(2, map!!.size)
        Assert.assertEquals(mapOf("key1" to "", "key2" to ""), map)
    }
